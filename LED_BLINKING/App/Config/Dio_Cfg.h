...
#define DioConf_LED2_CHANNEL_NUM             (Dio_ChannelType)2 /* Pin_2 in PORTF */
#define DioConf_LED3_CHANNEL_NUM             (Dio_ChannelType)3 /* Pin_3 in PORTF */
